    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-6 ">
          ...
          <a href="/about#address" class="text-decoration-none text-dark"><p>Direcci&oacute;n</p></a>
        </div>
        <div class="col-lg-3 col-md-3 col-6 ">
          <h6>Soporte</h6>
          <!--<a href="/about#faq" class="text-decoration-none text-dark"><p>FAQ</p></a>-->
          <a href="{{ route('customer.return.form') }}" class="text-decoration-none text-dark"><p>Solicitar devoluci&oacute;n/garant&iacute;a</p></a>
          <a href="/about#shippingandreturns" class="text-decoration-none text-dark"><p>Env&iacute;os y devoluciones</p></a>
          <a href="/about#warranty" class="text-decoration-none text-dark"><p>Garant&iacute;a</p></a>
        </div>
            ...
            <div class="row">
              <div class="col-3">
               <a href="https://www.instagram.com/">
                <p class="d-flex align-items-center">  <img src="{{ asset('client/img/icon-instagram.png') }}" alt="" class="img-fluid me-2">  @boutique_belleza</p>
                </a>
              </div>
            </div>
          </div>
